        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Registro de expediente (solo frontend)
                </p>
            </div>
                ...
                <form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ej: EXP-001"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Contrato</label>
                            <input type="text" placeholder="Ej: CONTRATO-2026"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">INE</label>
                            <input type="text" placeholder="Ej: INE-ARCHIVO.PDF"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Ruta Documentos</label>
                            <input type="text" placeholder="Ej: /documentos/expedientes/"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
