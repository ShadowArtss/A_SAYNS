        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Registro de un nuevo deudor (solo frontend)
                </p>
            </div>
                ...
                <form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ej: DEU-001"
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ej: Juan Alberto"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ej: PEGJ850101HDFRRN01"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ej: 5555555555"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Email</label>
                            <input type="email" placeholder="Ej: correo@gmail.com"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
