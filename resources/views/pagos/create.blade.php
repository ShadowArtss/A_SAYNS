        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Registro de pago (solo frontend)
                </p>
            </div>
            ...
            <div class="bg-white shadow-sm sm:rounded-xl p-8 border border-gray-200">
                ...
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">ID Pago</label>
                            <input type="text" placeholder="Ej: PAGO-001"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">ID Pagaré</label>
                            <input type="text" placeholder="Ej: PAG-010"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">ID Usuario</label>
                            <input type="text" placeholder="Ej: USR-005"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Monto Pago (MXN)</label>
                            <input type="number" placeholder="Ej: 2000"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Fecha de Pago</label>
                            <input type="date"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                <option selected disabled>Selecciona método</option>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Referencia de Transacción</label>
                            <input type="text" placeholder="Ej: TRANS-88990011"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
