        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Registro de dirección (solo frontend)
                </p>
            </div>
